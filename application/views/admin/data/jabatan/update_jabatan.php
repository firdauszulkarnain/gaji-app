                ...
                <div class="card-body px-5">
                    <form action="" method="POST" class="mt-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control  <?= (form_error('nama_jabatan')) ? 'is-invalid' : '' ?>" id="nama_jabatan" name="nama_jabatan" value="<?= $detail['nama_jabatan'] ?>" autocomplete="off">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control selectpicker border border-secondary" id="perusahaan" name="perusahaan" data-size="7" data-live-search="true">
                                <option value="<?= $detail['id_perusahaan'] ?>" selected><?= $detail['nama_perusahaan'] ?></option>
                                <?php foreach ($perusahaan as $pt) : ?>
                                    <?php if ($pt['id_perusahaan'] != $detail['id_perusahaan']) : ?>
                        ...
                        <div class="form-row mt-4">
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" class="form-control uang <?= (form_error('gaji_pokok')) ? 'is-invalid' : '' ?>" id="gaji_pokok" name="gaji_pokok" value="<?= number_format($detail['gaji_pokok'], 0, ',', '.') ?>" autocomplete="off">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" class="form-control uang" id="tj_makan" name="tj_makan" value="<?= number_format($detail['tj_makan'], 0, ',', '.') ?>" autocomplete="off">
                            </div>
                            <div class="form-group col-md-4">
                                <label for="tj_transportasi" class="text-dark font-weight-bold">Tunjangan Transportasi</label>
                                <input type="text" class="form-control uang" id="tj_transportasi" name="tj_transportasi" value="<?= number_format($detail['tj_transportasi'], 0, ',', '.') ?>" autocomplete="off">
                            </div>
                        </div>
